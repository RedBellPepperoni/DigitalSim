...
#include "SmoothCameraComponent.h"

// Sets default values for this component's properties
USmoothCameraComponent::USmoothCameraComponent()
{
	...
	//Disabling collidion to prevent weird camera behaviour
...
void USmoothCameraComponent::MoveCameraLeftRight(const float Value)
{
	CameraLeftRightAxisValue = Value;
}

void  USmoothCameraComponent::MoveCameraUpDown(const float Value)
{
	CameraUpDownAxisValue = Value;
}

void  USmoothCameraComponent::RotateCameraPressed()
{
...
void  USmoothCameraComponent::RotateCameraReleased()
{
	bShouldRotateCamera = false;
}
void  USmoothCameraComponent::ZoomCamera(const float Value)
{
...
void USmoothCameraComponent::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void USmoothCameraComponent::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
APlayerController* USmoothCameraComponent::GetPlayerControllerForOwningPawn() const
{
	APawn* Pawn = GetOwningPawn();
...
APawn* USmoothCameraComponent::GetOwningPawn() const
{
